...
main(int argc, char* argv[])
{
  ...
  pcl::PointCloud<pcl::PointXYZ> pointcloud_a =
      distance::io::read_pointcloud(std::string(argv[1]));
  pcl::PointCloud<pcl::PointXYZ> pointcloud_b =
      distance::io::read_pointcloud(std::string(argv[2]));
